...
</style></head><body><img alt="" src="/images/ColorQ_logo_png.png" 
style="width:20%"><div class="main"><h1>Welcome to COLOR Q!</h1><h3>
Thank you for installing my application!</h3><b>Next steps:</b><br><br>
Connect the module to your local WiFi here!<br><button 
onclick='window.location.href="/settings/wifi"'>WiFi settings</button><br>
<button onclick='window.location.href="/settings/leds"'>LED Preferences</button>
<br><i>Just trying this out in AP mode?</i><br><button 
