...
function H(){window.open("https://colorq.in/")}function B(){window.open("/settings","_self")}function GetV() {var d=document;
...
</select><br>AP IP: <span class="sip">Not active</span><br><hr><button 
